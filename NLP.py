...
cd c:\\Users\\brench\\Intro to Machine Learning\\Assignments\\Assignment 8\\embeddings


# In[2]:


# This is the one assignment provided on github, where the template code makes up the 
# majority of the code as this process is quite lengthly. I was required
# created two alternative RNN structures and performed hyperparameter testing.
#  Using starter code as template, I then created four seperate language models.


# Starter code provided by Thomas W. Miller, August 16, 2018
...
embeddings_directory = 'c:\\Users\\brench\\Intro to Machine Learning\\Assignments\\Assignment 8\\embeddings\\gloVe.6B'
...
# these to the usual English stopwords to be dropped from a document collection
    more_stop_words = ['cant','didnt','doesnt','dont','goes','isnt','hes',        'shes','thats','theres','theyre','wont','youll','youre','youve', 'br'        've', 're', 'vs'] 

    some_proper_nouns_to_remove = ['dick','ginger','hollywood','jack',        'jill','john','karloff','kudrow','orson','peter','tcm','tom',        'toni','welles','william','wolheim','nikita']
...
EVOCABSIZE = 40000  # specify desired size of pre-defined embedding vocabulary 
...
# Select the pre-defined embeddings source        
# Define vocabulary size for the language model    
# Create a word_to_embedding_dict for GloVe.6B.100d
embeddings_directory = 'c:\\Users\\brench\\Intro to Machine Learning\\Assignments\\Assignment 8\\embeddings\\gloVe.6B'
...
for i in range(num_files):
    ...
    negative_documents.append(words)
    # print('Data size (Characters) (Document %d) %d' %(i,len(words)))
    # print('Sample string (Document %d) %s'%(i,words[:100]))
...
# Select the pre-defined embeddings source        
# Define vocabulary size for the language model    
# Create a word_to_embedding_dict for GloVe.6B.200d
embeddings_directory = 'c:\\Users\\brench\\Intro to Machine Learning\\Assignments\\Assignment 8\\embeddings\\gloVe.6B'
...
for i in range(num_files):
    ...
    negative_documents.append(words)
    # print('Data size (Characters) (Document %d) %d' %(i,len(words)))
    # print('Sample string (Document %d) %s'%(i,words[:200]))
...
# Select the pre-defined embeddings source        
# Define vocabulary size for the language model    
# Create a word_to_embedding_dict for GloVe.6B.300d
embeddings_directory = 'c:\\Users\\brench\\Intro to Machine Learning\\Assignments\\Assignment 8\\embeddings\\gloVe.6B'
...
for i in range(num_files):
    ...
    negative_documents.append(words)
    # print('Data size (Characters) (Document %d) %d' %(i,len(words)))
    # print('Sample string (Document %d) %s'%(i,words[:300]))
...
import pandas as pd
accuracymatrix = pd.DataFrame({'10000': [model50dev10k, model100dev10k,model200dev10k, model300dev10k], '20000': [model50dev20k,model100dev20k, model200dev20k, model300dev20k], '30000': [model50dev30k, model100dev30k, model200dev30k, model300dev30k], '40000': [model50dev40k, model100dev40k, model200dev40k, model300dev40k]})


# In[29]:


names = ['glove.6b.50d.txt', 'glove.6b.100d.txt', 'glove.6b.200d.txt', 'glove.6b.300d.txt']


# In[30]:


accuracymatrix.insert(loc=idx, column='Evocabsize', value=names)
...
# I didn't include all the code for the different learning rates and optimizers as its quite long. I simply changed the learning rate to .0001 and also tried MomentumOptimizer with momentum=.9
